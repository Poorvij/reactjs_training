...
function addProject() {
	...
	console.clear();
	document.getElementById("statusChangedLabel").style.display='none';
...
function showTable(obj) {
	...
	for(i=1;i<=obj.length;i++) {
		...
		cell3.innerHTML = '<select id="status'+obj[i-1].pid+'" onChange="changeStatus('+obj[i-1].pid+')"">'+
		...
		cell4.innerHTML = '<input type="button" id="d'+obj[i-1].pid+'" value="Delete Project" onCLick="deleteProject('+obj[i-1].pid+')">';
...
function changeStatus(pid){
	...
	document.getElementById("statusChangedLabel").style.display='inline';
	...
	document.getElementById("statusChangedLabel").innerHTML = notify.bold();
